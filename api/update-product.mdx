---
title: "PUT /ProductoServlet — Update an Existing Product by ID"
sidebarTitle: "Update Product"
description: "PUT /ServidorTiendaPlayeras/ProductoServlet — update all fields of a product by ID via query-string parameters. Returns JSON success flag."
---
